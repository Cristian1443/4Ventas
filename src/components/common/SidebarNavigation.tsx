  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        ...
        >
          {/* Icono de Settings con color sólido para evitar errores de ID */}
...
function MenuIcon({ icon, active }: { icon: string; active: boolean }) {
  ...
  return (
    <Svg width={size} height={size} viewBox={viewBox} fill="none" style={{ marginBottom: 8 }}>
      <Path
        d={iconData.path}
        // CORRECCIÓN: Usar color sólido en lugar de gradiente para evitar problemas de ID
        stroke={active ? "white" : "#092090"}
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="1.1791"
      />
...
const styles = StyleSheet.create({
  container: {
    ...
    // Sombra más suave y nativa
    shadowColor: '#00094D',
    shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.1,
    shadowRadius: 12,
    elevation: 10,
    paddingTop: 30, // Un poco más de aire arriba
    paddingBottom: 30,
    alignItems: 'center',
  ...
  menuItemsContainer: {
    flex: 1,
    alignItems: 'center',
    justifyContent: 'flex-start', // Alinearlos arriba con separación
    width: '100%',
    paddingTop: 20, 
    gap: 10, // Espacio constante entre items (React Native 0.71+)
  },
  bottomSection: {
    alignItems: 'center',
    width: '100%',
  ...
  logoContainer: {
    width: 54, // Ligeramente más grande que 48
    height: 54,
    marginBottom: 10,
  ...
  menuItem: {
    width: 64, // Cuadrado o casi cuadrado se ve mejor centrado en barra de 80
    height: 64, 
    alignItems: 'center',
    justifyContent: 'center',
    // Eliminamos marginBottom porque usamos 'gap' en el contenedor
    borderRadius: 16, // Radio más moderno (no circular completo)
  },
  menuItemActive: {
  ...
  menuLabel: {
    fontFamily: 'Inter',
    fontWeight: '500', 
    fontSize: 11, // 11px está bien si el icono es grande
    lineHeight: 14,
    marginTop: 4, // Separación entre icono y texto
    color: '#697b92', // Color visible por defecto para UX (opcional)
    display: 'flex', // Asegura que se renderice
  },
  menuLabelActive: {
    color: '#ffffff',
    fontWeight: '600',
